...
void CTentacle::Precache()
{
	...
	PrecacheSoundArray(pHitSilo, ARRAYSIZE(pHitSilo));
    PrecacheSoundArray(pHitDirt, ARRAYSIZE(pHitDirt));
    PrecacheSoundArray(pHitWater, ARRAYSIZE(pHitWater));
}
