...
/**
 * @brief Precaches all necessary client resources such as sounds and models.
 */
void ClientPrecache()
{
    ...
    // PrecacheSound("player/pl_jumpland2.wav"); // UNDONE: play 2x step sound
    ...
    UTIL_PrecacheSound("plats/vehicle_ignition.wav"); // Use a vehicle
